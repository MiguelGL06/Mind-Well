...
const createCustomerSchema = Joi.object({
  ...
  lastName: Joi.string().required(), // El apellido debe ser una cadena y obligatorio
  phone: Joi.string().required(), // El teléfono debe ser una cadena y obligatorio
...
const updateCustomerSchema = Joi.object({
  ...
  lastName: Joi.string(), // El apellido debe ser una cadena (opcional)
  phone: Joi.string(), // El teléfono debe ser una cadena (opcional)
