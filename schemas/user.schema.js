...
const createUserSchema = Joi.object({
  ...
  role: Joi.string().min(5).required() // El rol debe ser una cadena de al menos 5 caracteres y obligatoria
});
...
const updateUserSchema = Joi.object({
  ...
  role: Joi.string().min(5), // El rol debe ser una cadena de al menos 5 caracteres (opcional)
});
